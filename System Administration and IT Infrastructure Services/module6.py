...
We could standardize hardware procurement, implement an inventory management system, centralized onboarding process, include a password management and recovery, helpdesk ticketing system,
1 point
2.
Question 2
Scenario 2:
...
To improve we could automated imaging and deployment, we could add a cloud migration, a file server backups, we care about to access control and folder permissions, a helpdesk and ticketing system too
1 point
3.
Question 3
...
The process we can include is a hardware procurement planning, a impreve for a server reliability, and user management practices and with this simplify internal tools, and for last centralized documentation knowledge base
"""
